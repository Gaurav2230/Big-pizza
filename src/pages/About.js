  ...
  return (
    <div className='about'>
        ...
        <div className='aboutBottom'>
            <h1>About us</h1>
            <p>
            Big Pizza is all about quality you can trust. As one of the original founding Pizza brands and the 3rd largest Pizza chain in India, our sole mission is making the freshest, tastiest and funnest Pizza around.
